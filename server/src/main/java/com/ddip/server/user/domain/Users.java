...
public class Users {
  ...
  public void update(String nickname, String emoji, String password) {
    if (Strings.isNotEmpty(nickname) || Strings.isNotBlank(nickname)) {
      this.nickname = nickname;
    }
    if (Strings.isNotEmpty(emoji) || Strings.isNotBlank(emoji)) {
      this.emoji = emoji;
    }
    if (Strings.isNotEmpty(password) || Strings.isNotBlank(password)) {
      this.password = password;
    }
  }
